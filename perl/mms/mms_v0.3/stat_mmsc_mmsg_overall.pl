...
sub daily_dispose
{
	...
	$sql = "delete from TSMD_MMSC_MMSG_OVERALL" 
	...
	foreach my $key (keys %$stat_row_hash)
	{
		...
		$sql = "insert into TSMD_MMSC_MMSG_OVERALL(START_TIME,AREA_CODE,SUCC_MO,ATT_MO,RATIO_MO,"
				. "SUCC_MO_REPORT,ATT_MO_REPORT,RATIO_MO_REPORT,NE_TYP)"
				. " values (to_date('$startdate','yyyy-mm-dd'),$key,$succ_ao,$att_ao,$ao_ratio,"
	...
	$sql = "insert into TSMD_MMSC_MMSG_OVERALL(START_TIME,AREA_CODE,SUCC_MO,ATT_MO,RATIO_MO,"
			. "SUCC_MO_REPORT,ATT_MO_REPORT,RATIO_MO_REPORT,NE_TYP)"
			. " values (to_date('$startdate','yyyy-mm-dd'),$PROVID,$prosucc_ao,$proatt_ao,$proao_ratio,"
