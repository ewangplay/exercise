...
sub daily_dispose
{
	...
	$sql = "delete from TSMD_CDR_MM7_AO_FCAA" 
	...
	# stat mm7 fcaa num grouped by area, mm7 result and mms status
	$sql = "select C.area_code, A.statuscode, B.mmse_result, count(*)" 
       		. " from TSMC_MMSC A,TSMC_MMS_MM7 B, TSMS_START_GT C" 
	...
	# stat mm7 fcaa num grouped by area and mms status code
	...
	# stat mm7 fcaa num grouped by area
	$stat_row_hash = {};
	...
	# stat mm7 fcaa num grouped by mms status and mm7 result
	...
	# stat total fcaa num grouped by mms status code
	...
	# update mms status tital and mm7 result title
...
sub update_title
{
	...
	$sql = "update TSMD_CDR_MM7_AO_FCAA a" 
       		. " set RESULT_TITLE = (select DESCRIPTION_CN from TSMS_MMS_STATIC_DATA b" 
	       	. " where a.RESULT>=b.BEGIN_ID and a.RESULT<=b.END_ID and b.title_id=150)"
  		. " where (start_time between to_date('$startdate 00:00:00','yyyy-mm-dd hh24:mi:ss')" 
		. " and to_date('$startdate 23:59:59','yyyy-mm-dd hh24:mi:ss'))"
