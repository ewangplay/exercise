...
int main( int argc, char *argv[] )
{
	...
	* 时会发生这个事件*/
    ...
    g_signal_connect(G_OBJECT(button), "toggled", G_CALLBACK(check_callback), "radio button 1");

    /* pack the radio button into the table */
    ...
    button = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(button), "radio button 2");
    g_signal_connect(G_OBJECT(button), "toggled", G_CALLBACK(check_callback), "radio button 2");
    ...
    button = gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(button), "radio button 3");
    g_signal_connect(G_OBJECT(button), "toggled", G_CALLBACK(check_callback), "radio button 3");
    ...
    /* make the cancel button to become the default widget */
